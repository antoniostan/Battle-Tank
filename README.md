# Battle-Tank
This covers up the battle tank tutorial from the unreal development course. This game is an open world head-to-head tank battle.
...
How to workaround the "ConvexElem Invalid" error
